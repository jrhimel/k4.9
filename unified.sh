...
git clone https://github.com/ljb233/android_prebuilts_gcc_linux-x86_aarch64_aarch64-linux-gnu-linaro-5.5.0.git gcc --depth=1
...
export BUILD_CROSS_COMPILE="$HOME/TC/gcc/bin/aarch64-linux-gnu-"
...
export PATH="$KERNELDIR/gcc/bin:${PATH}"
...
# Start the build
# ================
${MAKE} -j${JOBS} \ ARCH=arm64 \ CROSS_COMPILE=aarch64-linux-gnu- | tee build-log.txt ;
...
message="CI build of SolarisKernel completed with the latest commit."
...
🗒️ <b>Build-Type</b>  : <code>NonTreble-Pie</code>
